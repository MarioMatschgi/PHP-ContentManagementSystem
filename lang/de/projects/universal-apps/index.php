<?php
  ...
  if ($pr_short == true) {
    $pr_p = 'Du benutzt deinen PC wahrscheinlich auch täglich für Stunden, daher sind Apps ein essenzieller Teil der Produktivität. Hier sind einige Apps die ich entwickelt habe um den Komfort und die Produktivität zu erhöhen.';
  } else {
        ...
        'Herunterladen & installieren' => 
          array(
            ...
            'Installation' => 
              array(
                array(
                  'MacOS:<br>Lade die .dmg Datei herunter und Doppelklicke (oder Rechtsklick und "Öffnen") sie. Ziehe die .app Datei auf den Programme Ordner.',
                  'Windows:<br>Lade die .exe Datei herunter und Doppelklicke (oder Rechtsklick und "Öffnen") sie. Falls sich WindowsDefender öffnet, einfach trotzdem installieren, dies kann vorkommen, da ich nicht zum Signieren der App bezahlt habe.'
                ),
              ),
            'Download' => 
